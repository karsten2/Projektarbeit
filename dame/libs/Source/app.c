...
#define S32_t CPU_INT32S
#define S16_t CPU_INT16S
#define U32_t CPU_INT32U
#define U16_t CPU_INT16U

int  main2 (void)
{
    OS_ERR  err;

    volatile S32_t Aux__ib;
    volatile S32_t Aux__mb = -1;
    volatile U16_t Sars65_Lookup_Table = 6133;

    BSP_IntDisAll();                                            /* Disable all interrupts.                              */

    Aux__mb += 1;
    Sars65_Lookup_Table += 1;

    Aux__ib = (S32_t) (( (U32_t) ( (Aux__mb >268427264) ? 32767 :
    (S16_t)(Aux__mb >> 13) )) - ((U32_t) (U16_t) ((((U32_t)
    Sars65_Lookup_Table) * ((U32_t) 2589 )) >> 15)));
